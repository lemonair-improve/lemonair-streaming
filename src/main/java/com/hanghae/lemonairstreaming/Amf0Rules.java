package com.hanghae.lemonairstreaming;
...
public class Amf0Rules {
	...
	public static Object decode(ByteBuf buf) {
		...
		return switch (type) {
			...
			case NULL, UNDEFINED, UNSUPPORTED -> null;
	...
	public enum Type {
		NUMBER(0x00), BOOLEAN(0x01), STRING(0x02), 
		OBJECT(0x03), NULL(0x05), UNDEFINED(0x06), 
		ECMA_ARRAY(0x08), OBJECT_END(0x09), 
		STRICT_ARRAY(0x0A), DATE(0x0B), LONG_STRING(0x0C), UNSUPPORTED(0x0D),

		/* Not supported */
		RECORDSET(0x0E), XML_DOCUMENT(0x0F), TYPED_OBJECT(0x10);
